...
namespace StudyProductivityApp.Persistence.Migrations
{
    ...
    [Migration("20250124182752_SwitchingToProductionDatabase")]
    partial class SwitchingToProductionDatabase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.AnswerOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.Concept", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConceptListId");

                    b.ToTable("Concepts");
                });

            modelBuilder.Entity("StudyProductivityApp.Core.Models.ConceptList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.Folder", b =>
                {
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.FolderAccess", b =>
                {
                    b.Property<int>("FolderAccessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FolderAccessId"));
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.Quiz", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.SelfTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.SelfTestQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.TodoTaskList", b =>
                {
                    b.Property<int>("TodoTaskListId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.AnswerOption", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.Question", "Question")
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.Concept", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.ConceptList", "ConceptList")
                        .WithMany("Concepts")
                        .HasForeignKey("ConceptListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.Folder", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.Folder", "ParentFolder")
                        .WithMany("SubFolders")
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.FolderAccess", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.Folder", "Folder")
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.Question", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.Quiz", "Quiz")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.SelfTestQuestion", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.SelfTest", "SelfTest")
                        .WithMany("SelfTestQuestions")
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.TodoTask", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.TodoTaskList", "TodoTaskList")
                        .WithMany("TodoTasks")
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.UserFileAccess", b =>
                {
                    b.HasOne("StudyProductivityApp.Core.Models.User", "SharedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("StudyProductivityApp.Core.Models.SelfTest", b =>
                {
                    b.Navigation("SelfTestQuestions");
                });
